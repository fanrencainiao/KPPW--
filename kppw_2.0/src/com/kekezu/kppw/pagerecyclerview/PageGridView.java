...
/**
 * 可分页的gridview Created by zhuguohui on 2016/8/20 0020.
 */
public class PageGridView extends RecyclerView
{
	...
	public PageGridView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		TypedArray array = context
				.obtainStyledAttributes(attrs, R.styleable.PageGridView);
		...
		if (mRows > 0)
		{
			if (mColums > 0)
			{
				...
				setOnScrollListener(new PagingScrollListener());
			}
	...
	public final void setAdapter(Adapter adapter)
	{
		...
		if (needReorder)
		{
			...
			ArrayList<HashMap<String, Object>> data = pagingAdapter.getData();
			ArrayList<HashMap<String, Object>> formatData = new ArrayList<HashMap<String, Object>>();
	...
	public static abstract class PagingAdapter<VH extends ViewHolder> extends Adapter<VH>
	{
		 ...
		 * @return
		 */
		public abstract ArrayList<HashMap<String, Object>> getData();
		 ...
		 * @return
		 */
		public abstract HashMap<String, Object> getEmpty();
	}
