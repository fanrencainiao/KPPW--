...
public class NotificationInitSampleHelper extends IMNotification
{
	 ...
	 */
	@Override
	public CharSequence getNotificationTips(YWConversation conversation,
			YWMessage message, int totalUnReadCount, IMSmilyCache smilyCache)
	{
		// int bound = (int)
		// DemoApplication.getContext().getResources().getDimension(
		// com.alibaba.sdk.android.R.dimen.aliwx_smily_column_width);
		// CharSequence charSequence=
		// smilyCache.getSmilySpan(DemoApplication.getContext(),
		// message.getContent(), bound, false);
	 ...
	 */
	public Intent getCustomNotificationIntent(YWConversation conversation,
	 ...
	 */
	@Override
	public String getTicker(YWConversation conversation, YWMessage message,
