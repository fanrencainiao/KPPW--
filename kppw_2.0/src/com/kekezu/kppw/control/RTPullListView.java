...
public class RTPullListView extends ListView implements OnScrollListener
{
	...
	private void init(Context context)
	{
		...
		reverseAnimation = new RotateAnimation(-180, 0, RotateAnimation.RELATIVE_TO_SELF,
	...
	{
		state = DONE;
		String a = getResources().getString(R.string.updating) + new Date().getHours()
				+ ":" + new Date().getMinutes() + ":" + new Date().getSeconds();
		lastUpdatedTextView.setText(a);
		changeHeaderViewByState();
		invalidateViews();
		setSelection(0);
	}
