...
public class ImageViewClipZoom extends ImageView implements
...

{
	...
	public ImageViewClipZoom(Context context)
	{
		this(context, null);
	}

	public ImageViewClipZoom(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		mGestureDetector = new GestureDetector(context,
				new SimpleOnGestureListener()
				{
					...
					public boolean onDoubleTap(MotionEvent e)
					{
						...
						{
							ImageViewClipZoom.this.postDelayed(
	...
	private class AutoScaleRunnable implements Runnable
	{
		...
		public void run()
		{
			...
			{
				ImageViewClipZoom.this.postDelayed(this, 16);
			}
			else
			// 设置为目标的缩放比例
			{
	...
	public Bitmap clip()
	{
		...
		// return getCircleBitmap(Bitmap.createBitmap(bitmap,
		// mHorizontalPadding,
		// mVerticalPadding, getWidth() - 2 * mHorizontalPadding,
		// getWidth() - 2 * mHorizontalPadding));
	}
