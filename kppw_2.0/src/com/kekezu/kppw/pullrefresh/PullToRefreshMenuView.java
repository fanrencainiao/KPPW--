...
import com.kekezu.kppw.tools.Utils;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshMenuView extends PullToRefreshBase<SwipeMenuListView> implements
		OnScrollListener
{
	...
	protected SwipeMenuListView createRefreshableView(Context context, AttributeSet attrs)
	{
		...
		listView.setDivider(getResources().getDrawable(R.color.light_gray8));
	...
	private boolean isFirstItemVisible()
	{
		...
		int mostTop = (mListView.getChildCount() > 0) ? mListView.getChildAt(0).getTop()
				: 0;
		if (mostTop >= 0)
		{
			return true;
