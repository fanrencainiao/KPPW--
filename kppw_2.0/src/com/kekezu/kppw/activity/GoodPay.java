...
public class GoodPay extends Activity
{
	...
	OnClickListener listener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.button_queding:
				...
				{
					dialog1.cancel();
					progressDialog = new LoadingDialog(GoodPay.this);
	...
	Runnable newTread = new Runnable()
	{
		...
		public void run()
		{
			strRe = WorkDP.cashPayGoods(strId, 0, mPetPwd.getText().toString(),
					GoodPay.this);
	...
	private Handler tHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case 1:
				...
				Toast.makeText(GoodPay.this, strRe.get("msg"), 2000).show();
				break;
			}
		}
	};
	...
	protected void payType1()
	{
		...
		dialog1 = new Dialog(GoodPay.this);
	...
	protected void payType2()
	{
		 ...
		 * 完整的符合支付宝参数规范的订单信息
		 */
		final String payInfo = WorkDP.ThirdCashGoodsPay(strId, "alipay", this);
		...
		Runnable payRunnable = new Runnable()
		{
			...
			{
				// 构造PayTask 对象
				PayTask alipay = new PayTask(GoodPay.this);
				// 调用支付接口，获取支付结果
	...
	private Handler mHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case SDK_PAY_FLAG:
			{
				...
				{
					Toast.makeText(GoodPay.this, "支付成功", Toast.LENGTH_SHORT).show();
				...
				else
				{
					...
					{
						Toast.makeText(GoodPay.this, "支付结果确认中", Toast.LENGTH_SHORT)
								.show();
					}
					else
					{
						// 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
						Toast.makeText(GoodPay.this, "支付失败", Toast.LENGTH_SHORT).show();
					}
				}
				break;
			}
	...
	protected void payType3()
	{
		 ...
		 * 完整的符合支付宝参数规范的订单信息
		 */
		final String payInfo = WorkDP.ThirdCashGoodsPay(strId, "wechat", this);;

		Toast.makeText(GoodPay.this, "获取订单中...", Toast.LENGTH_SHORT).show();
		try
		{
			if (payInfo != null && payInfo.length() > 0)
			{
				...
				else
				{
					...
					Toast.makeText(GoodPay.this, "返回错误" + json.getString("retmsg"),
			...
			else
			{
				...
				Toast.makeText(GoodPay.this, "服务器请求错误", Toast.LENGTH_SHORT).show();
			}
		}
		catch (Exception e)
		{
			Log.e("PAY_GET", "异常：" + e.getMessage());
			Toast.makeText(GoodPay.this, "异常：" + e.getMessage(), Toast.LENGTH_SHORT)
					.show();
		}
	}
}
