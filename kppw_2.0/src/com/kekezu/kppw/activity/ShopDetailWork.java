...
public class ShopDetailWork extends BaseFragment
{
	...
	public ShopDetailWork(String strShopId2)
	{
				...
				new Thread(new Runnable()
				{
					public void run()
					{
						try
						{
							Thread.sleep(2000);
							page++;
							workList.addAll(ShopDetailDP.getShopWork(strShopId, page,
									getActivity()));
	...
	protected void initData()
	{
		...
		workList = ShopDetailDP.getShopWork(strShopId, page, getActivity());
		itemAdapter = new ServiceAndGoodAdapter(getActivity(), workList, "1");
