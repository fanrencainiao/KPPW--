...
public class TaskReleasePay extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		{
			info = TaskDP.getTaskBill(getIntent().getStringExtra("strResult"));
			setViewValue();
		}
	}
	...
	{
		strTaskId = info.get("task_id");
		tvTitle.setText(info.get("title"));
		tvMoney.setText("¥" + info.get("money"));
		tvBalance.setText("¥" + info.get("balance"));
	}
	...
	OnClickListener listener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.button_queding:
				...
				{
					dialog1.cancel();
					progressDialog = new LoadingDialog(TaskReleasePay.this);
					progressDialog.setCancelable(false);
					progressDialog.show();
	...
	Runnable newTread = new Runnable()
	{
		...
		public void run()
		{
			Log.e("strTaskId", strTaskId);
			Log.e("mPetPwd", mPetPwd.getText().toString());

			strRe = TaskDP.bountyByBalance(strTaskId, 0, mPetPwd.getText().toString(),
					TaskReleasePay.this);
	...
	Runnable newTread1 = new Runnable()
	{
		...
		public void run()
		{
			String str = TaskDP.bountyBidTask(strTaskId, TaskReleasePay.this);
			info = TaskDP.getTaskBill(str);
	...
	private Handler tHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case 1:
				...
				{
					Toast.makeText(TaskReleasePay.this, str[1], 2000).show();
				}
	...
	protected void payType1()
	{
		...
		dialog1 = new Dialog(TaskReleasePay.this);
	...
	protected void payType2()
	{
		 ...
		 * 完整的符合支付宝参数规范的订单信息
		 */
		final String payInfo = TaskDP.postCash(info.get("title"), info.get("money"),
				"alipay", strTaskId, this);
		...
		Runnable payRunnable = new Runnable()
		{
			...
			{
				// 构造PayTask 对象
				PayTask alipay = new PayTask(TaskReleasePay.this);
				// 调用支付接口，获取支付结果
	...
	private Handler mHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case SDK_PAY_FLAG:
			{
				...
				{
					Toast.makeText(TaskReleasePay.this, "支付成功", Toast.LENGTH_SHORT)
							.show();
					if (getIntent().getStringExtra("strResult").equals("task"))
					{
						TestEvent event = new TestEvent();
				...
				else
				{
					...
					{
						Toast.makeText(TaskReleasePay.this, "支付结果确认中", Toast.LENGTH_SHORT)
								.show();
					}
					else
					{
						// 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
						Toast.makeText(TaskReleasePay.this, "支付失败", Toast.LENGTH_SHORT)
								.show();
					}
				}
				break;
	...
	protected void payType3()
	{
		 ...
		 */
		final String payInfo = TaskDP.postCash(info.get("title"), info.get("money"),
				"wechat", strTaskId, this);

		Toast.makeText(TaskReleasePay.this, "获取订单中...", Toast.LENGTH_SHORT).show();
		try
		{
			if (payInfo != null && payInfo.length() > 0)
			{
				...
				else
				{
					...
					Toast.makeText(TaskReleasePay.this,
			...
			else
			{
				...
				Toast.makeText(TaskReleasePay.this, "服务器请求错误", Toast.LENGTH_SHORT).show();
			}
		}
		catch (Exception e)
		{
			Log.e("PAY_GET", "异常：" + e.getMessage());
			Toast.makeText(TaskReleasePay.this, "异常：" + e.getMessage(),
